...
<body>
  <br>
  <h1>Yimwaan Gallery</h1>

    <button type="button" class="btn btn-primary">อัพโหลดรูป</button>
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div id="reel">
        ...
        <div id="header" class="item" data-width="400">
          ...
          <article class="item thumb" data-width="282">
            <h2>aaaaaa</h2>
            <a href="images/fulls/dog1.jpg" class="image"><img src="images/thumbs/dog1.jpg" alt=""></a>
          </article>

          <article class="item thumb" data-width="384">
            <h2>Ad Infinitum</h2>
            <a href="images/fulls/dog2.jpg" class="image"><img src="images/thumbs/dog2.jpg" alt=""></a>
          </article>

          <article class="item thumb" data-width="274">
            <h2>Different.</h2>
            <a href="images/fulls/dog3.jpg" class="image"><img src="images/thumbs/dog3.jpg" alt=""></a>
          </article>
      ...
      <div id="footer">
        <div class="left">
          <p>This is <strong>Yimwaan Gallery</strong>, a responsive portfolio site template by <a href="http://html5up.net">HTML5 UP</a>. Free for personal<br />
      ...
      $(function(){
        $('a[title="Hosted on free web hosting 000webhost.com. Host your own website for FREE."]').empty();
      });
